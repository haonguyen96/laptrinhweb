<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dangnhap.aspx.cs" Inherits="Cheshire.Backend.dangnhap" %>
...
<body>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div><h2>Đăng nhập hệ thống quản lý Cheshire StoreBrooke</h2></div>
                <div style="color:red;">
